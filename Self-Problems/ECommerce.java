...
class Product {
    ...
    // constructer to initialize product
...
class Order {
    ...
    // contructer to initialize order
...
class Customer {
    ...
    // constructer to initialze customer object
...
public class ECommerce {
    ...
    public static void main(String[] args) {
        ...
        Product product2 = new Product("Ear buds", 6000);
        ...
        Customer customer = new Customer("Rajveer", order);
